...
if __name__ == "__main__":
    ...
    print(get_count_vertices(county_simplified), 'vertices in your simplified boundary file')
    ...
    for year in years:
        ...
        print(year,products_gdf)
        products_gdf.to_csv('temp.csv', mode='a')
        #
        ...
        year_name_dict[year] = str(products_gdf.title.iloc[0])

    # with open('year_name_json.json', 'w') as outputfile:
    #     json.dump(year_name_dict, outputfile, sort_keys= True)
